                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title" id="basic-layout-form-center">Tambah Data Ayam</h4>
                                            ...
                                            <div class="form-body">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="eventInput1" class="form-control @error('jenis')
                                                        is-invalid
                                                    @enderror"
                                                        placeholder="Masukkan Jenis Ayam" name="jenis">
                                                    @error('jenis')
                                                        <span
                                            ...
                                            <div class="form-body">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="eventInput1" class="form-control @error('harga')
                                                        is-invalid
                                                    @enderror"
                                                        placeholder="Masukkan Harga Ayam" name="harga">
                                                    @error('harga')
                                                        <span
